    ...
    {	
        ...
        addButton.setOnAction(new EventHandler<ActionEvent>() {
        	...
        	public void handle(ActionEvent event)
        	{
        		...
        		if(tempTask.getDescription() != null || tempTask.getDue() != null)
        		{
            		taskTable.addToList(tempTask);		//Need to make sure no duplicates are added (have addToList return boolean)
    	...
    	public taskEntry entryWindow(Stage stage)
        {
            ...
            acceptButton.setOnAction(new EventHandler<ActionEvent>() {
            	...
            	public void handle(ActionEvent event)
            	{
            		...
            		{
            			tempTask.setDescription(descText.getText());
